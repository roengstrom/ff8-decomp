...
PSYQ43_SRCS := src/snd_init.c src/snd_dma.c src/snd_voice.c src/snd_bank.c src/snd_param.c src/snd_note.c src/snd_track.c src/snd_cmd.c src/snd_cmd2.c

# Source files compiled without -G0 (default is -G0)
NO_G0_SRCS := src/main.c src/snd_cmd.c src/snd_cmd2.c
