...
| `src/34C8.c` | PsyQ 4.3 | 62 | 17 | 79 | 78.5%  |
...
| `src/10DD0.c` | PsyQ 4.1 | 36 | 5 | 41 | 87.8% |
...
| `src/186F8.c` | PsyQ 4.1 | 66 | 50 | 116 | 56.9% |
| `src/1B630.c` | PsyQ 4.1 | 12 | 2 | 14 | 85.7% |
...
| **Total (game code)** | | **596** | **1332** | **1928** | **30.9%** |
